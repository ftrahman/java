...
public class PA3 extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener {
	...
	public void keyTyped(KeyEvent key) {
		...
		case 'r':
			...
			break;
		// allows food to appear/disappear
		case 'F':                                 
        case 'f':
            vivarium.drawFood = !vivarium.drawFood;
            break;
        // function to add food
        case 'A':
        case 'a':
            if(vivarium.foodLimit != vivarium.curFood) {
              vivarium.curFood++;
            }
            break;
        ...
        case 'S':
        case 's':
            if(vivarium.curFood != -1) {
              vivarium.curFood--;
            }
            break;
//        case 'D':
//        case 'd':
//          vivarium.school = !vivarium.school;
//          vivarium.group();
//          break;
		default:
			break;
