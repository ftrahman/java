/**
 * A model for the abdomen of an ant as a sphere scaled in one direction.
 * 
 * Boiler Plate:
...
public class Abdomen extends Circular implements Displayable {
    ...
    public void initialize(final GL2 gl) {
        ...
        // Create an ellipsoid for the abdomen by scaling a sphere.
